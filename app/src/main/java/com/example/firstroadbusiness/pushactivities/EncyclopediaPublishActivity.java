...
public class EncyclopediaPublishActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void iniViews(){
        ...
        editTexts = new EditText[]{
                (EditText) findViewById(R.id.text_1_title),
                (EditText) findViewById(R.id.text_2),
                (EditText) findViewById(R.id.text_3),
                (EditText) findViewById(R.id.text_4),
                (EditText) findViewById(R.id.text_5),
        };
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.publish:
                showProgress(EncyclopediaPublishActivity.this.getWindow().getDecorView());
                publish();
                break;
    ...
    private void loadImage(){
        if(ContextCompat.checkSelfPermission(EncyclopediaPublishActivity.this,
                Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED){
            ActivityCompat.requestPermissions(EncyclopediaPublishActivity.this,new String[]{
            ...
            case 2://这里的requestCode是我自己设置的，就是确定返回到那个Activity的标志
                if (resultCode == RESULT_OK) {//resultcode是setResult里面设置的code值
                    try {
                        ...
                        Toast.makeText(EncyclopediaPublishActivity.this,path[imageFlag],Toast.LENGTH_SHORT).show();
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
    ...
    private void publish(){
        int i = 0;
        introduces = new String[editTexts.length];
        for (EditText editText : editTexts){
            introduces[i++] = editText.getText().toString();
        }
        if (false){
            MyToast.MyToast(EncyclopediaPublishActivity.this, "必须添加图片");
        }else {
            if (BmobUser.isLogin()){
                encyclopedia = new Encyclopedia();
                encyclopedia.setAwesomes(0);
                ...
                encyclopedia.save(new SaveListener<String>() {
                    ...
                    public void done(String s, BmobException e) {
                        if (e == null){
                            ...
                            MyToast.MyToast(EncyclopediaPublishActivity.this, "发布失败" + e.getMessage());
                        }
                    }
                });
            }else {
                MyToast.MyToast(EncyclopediaPublishActivity.this, "请先登录");
            }
        }
    }
        ...
        BmobFile.uploadBatch(path, new UploadBatchListener() {
            ...
            public void onSuccess(List<BmobFile> files, List<String> urls) {
                ...
                if(urls.size()==path.length){//如果数量相等，则代表文件全部上传完成
                    ...
                    encyclopedia.setBmobFiles(bmobFiles);
                    encyclopedia.update(new UpdateListener() {
                        @Override
                        public void done(BmobException e) {
                            if (e == null) {
                                MyToast.MyToast(EncyclopediaPublishActivity.this, "发布成功");
                                finish();
                            } else {
                                MyToast.MyToast(EncyclopediaPublishActivity.this, "发布失败" + e.getMessage());
                            }
            ...
            public void onError(int statuscode, String errormsg) {
                MyToast.MyToast(EncyclopediaPublishActivity.this, "错误码"+statuscode +",错误描述："+errormsg);
            }
    ...
    public void showProgress(View source){
        ...
        //重新开始填充数组
        hasDta = 0;
        progressDialog02 = new ProgressDialog(EncyclopediaPublishActivity.this);
